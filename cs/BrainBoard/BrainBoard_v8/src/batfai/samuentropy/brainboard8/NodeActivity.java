...
public class NodeActivity extends android.app.Activity
{
	...
	/*
	private java.util.ArrayList<android.widget.ImageView> images;
    ...
    public void onCreate(android.os.Bundle savedInstanceState)
	{
		...
		images = new java.util.ArrayList<android.widget.ImageView>();
		linearLayout = (android.widget.LinearLayout)findViewById(R.id.nodelist);
		...
		for(int i = 0; i<nodeIds.size(); i++)
		{
			...
			iv.setImageResource(nodeIds.get(i));
