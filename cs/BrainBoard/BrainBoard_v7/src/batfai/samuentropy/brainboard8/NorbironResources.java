...
public class NorbironResources
{
	...
	public void initResources()
	{
		...
		for(int i = 0; i<procIDs.length; i++)
		{
			...
			neuronBoxes.add(new NeuronBox(neuronSprite, 2 * 14, 64, 62, 10, norbironResource.getBitmap(), 0, 4));
		}
		...
		for(int i = 0; i<menuIDs.length; i++)
		{
			...
			menuBoxes.add(new NeuronBox(neuronSprite, 2 * 14, 64, 62, 10, norbironResource.getBitmap(), 0, 3));
		}	
	}
